...
namespace HoloTable.Data
{
    ...
    public sealed class MtgCardDefinition : EntityDefinition
    {
        ...
        /// <summary>Creatures always spawn (placeholder if needed); other permanents only with a prefab.</summary>
        public override bool SpawnsCreature => IsCreature || (IsPermanent && Prefab != null);
